    ...
    return (
        ...
        <div className="container mx-auto px-4 flex justify-center items-center min-h-[80vh]">
            <div className="w-full max-w-md p-8 bg-[#1a1f35]/80 backdrop-blur-lg rounded-xl shadow-xl border border-[#2a3449] relative z-1">
                <h1 className='text-3xl font-bold text-white mb-8 text-center bg-gradient-to-r from-[#ff2e6a] to-[#3399ff] bg-clip-text text-transparent'>Sign Up</h1>
                ...
                <form action="" method='POST' className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                    <div>
                        ...
                        <input 
                            ...
                            className={`w-full px-4 py-2 bg-[#0f1729] border border-[#2a3449] rounded-lg focus:outline-none focus:border-[#ff2e6a]  text-white z-20`} 
                    ...
                    >
                        ...
                        <div className="relative px-4 py-2 bg-[#1a2236] rounded-lg text-white text-sm font-medium group-hover:bg-[#242f4d] transition duration-300 text-center">
                            {isValid ? "Sign Up" : "Enter Valid Details"}
                        </div>
                    </button>
                </form>
            </div>
